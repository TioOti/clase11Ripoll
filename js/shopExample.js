document.addEventListener('DOMContentLoaded', () => {
    ...
    /**
    * Dibuja todois los productos a partir de la base de datos. No confundir con el carrito
    */
    function renderizarProductos() {
        listaDeProductos.forEach((Producto) => {
            const card_container__ = document.createElement("div")
            card_container__inner.add("card", "h-100", "align-items-center")
        })
    }
    ...
    function renderizarProductos() {
        listaDeProductos.forEach((Producto) => {
            ...
            miNodoTitle.innerText = Producto.nombre;            
            // Precio
            const miNodoPrecio = document.createElement('p');
            miNodoPrecio.classList.add('card-text');
            miNodoPrecio.innerText = `$${Producto.precio}`;
            //Stock
            const miNodoStock = document.createElement('p');
            miNodoStock.classList.add('card-text');
            miNodoStock.innerText = `Stock: ${Producto.stock}`;
            //Imagen
